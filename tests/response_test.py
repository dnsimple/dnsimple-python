...
class ResponseTest(unittest.TestCase):
    ...
    def test_contains_a_pagination_object(self):
        ...
        self.assertEqual(
            pagination.current_page, dnsimple_response.pagination.current_page
        )
        self.assertEqual(pagination.per_page, dnsimple_response.pagination.per_page)
        self.assertEqual(
            pagination.total_entries, dnsimple_response.pagination.total_entries
        )
        self.assertEqual(
            pagination.total_pages, dnsimple_response.pagination.total_pages
        )

...
from dnsimple.struct.zone_record import ZoneRecordUpdateInput
...
class ZoneRecordTest(DNSimpleTest):
    ...
    def test_create_record(self):
        ...
        record = self.zones.create_record(
            1010, "example.com", ZoneRecordInput("www", "A", "127.0.0.1")
        ).data
    ...
    def test_create_apex_record(self):
        ...
        record = self.zones.create_record(
            1010, "example.com", ZoneRecordInput("", "A", "127.0.0.1")
        ).data
    ...
    def test_update_record(self):
        ...
        record = self.zones.update_record(
            1010,
            "example.com",
            5,
            ZoneRecordUpdateInput(name="", content="mxb.example.com"),
        ).data
    ...
    def test_check_record_distribution(self):
        ...
        distribution = self.zones.check_zone_record_distribution(
            1010, "example.com", 5
        ).data

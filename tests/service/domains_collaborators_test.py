...
class DomainCollaboratorsTest(DNSimpleTest):
    ...
    def test_add_a_domain_collaborator_existing_user(self):
        ...
        collaborator = self.domains.add_collaborator(1010, 1, 'existing-user@example.com').data
    ...
    def test_add_a_domain_collaborator_invited_user(self):
        ...
        collaborator = self.domains.add_collaborator(1010, 1, 'invited-user@example.com').data

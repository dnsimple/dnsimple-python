...
from dnsimple.struct import DomainPremiumPriceOptions
from dnsimple.struct import DomainRenewRequest
...
class RegistrarTest(DNSimpleTest):
    ...
    def test_check_domain_premium_price(self):
        ...
        domain_premium_price = self.registrar.get_domain_premium_price(
            1010, "ruby.codes"
        ).data
    ...
    def test_get_domain_registration(self):
        ...
        domain_registration = self.registrar.get_domain_registration(
            1010, "bingo.pizza", 361
        ).data
    ...
    def test_check_domain_premium_price_passing_action(self):
        ...
        self.registrar.get_domain_premium_price(
            1010, "ruby.codes", DomainPremiumPriceOptions(action="registration")
        )
    ...
    def test_register_domain(self):
        ...
        domain_registration = self.registrar.register_domain(
            1010, "ruby.codes", DomainRegistrationRequest(2)
        ).data
    ...
    def test_transfer_domain(self):
        ...
        domain_transfer = self.registrar.transfer_domain(
            1010, "ruby.codes", DomainTransferRequest(2, "TheAuthCode")
        ).data
    ...
    def test_transfer_domain_missing_auth_code(self):
        ...
        try:
            self.registrar.transfer_domain(
                1010, "ruby.codes", DomainTransferRequest(2, "TheAuthCode")
            )
        except DNSimpleException as dnse:
    ...
    def test_transfer_domain_error(self):
        ...
        try:
            self.registrar.transfer_domain(
                1010, "google.com", DomainTransferRequest(2, "TheAuthCode")
            )
        except DNSimpleException as dnse:
            self.assertEqual(
    ...
    def test_get_domain_transfer(self):
        ...
        domain_transfer = self.registrar.get_domain_transfer(
            1010, "ruby.codes", 358
        ).data
    ...
    def test_cancel_domain_transfer(self):
        ...
        domain_transfer = self.registrar.cancel_domain_transfer(
            1010, "ruby.codes", 358
        ).data
    ...
    def test_renew_domain(self):
        ...
        domain_renewal = self.registrar.renew_domain(
            1010, "ruby.codes", DomainRenewRequest(period=1)
        ).data
    ...
    def test_renew_domain_too_early(self):
        ...
        try:
            self.registrar.renew_domain(
                1010, "example.com", DomainRenewRequest(period=1)
            )
        except DNSimpleException as dnse:
            self.assertEqual(

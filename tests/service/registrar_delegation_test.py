...
class RegistrarDelegationTest(DNSimpleTest):
    ...
    def test_get_domain_delegation(self):
        ...
        domain_delegation = self.registrar.get_domain_delegation(1010, 'example.com').data

        self.assertListEqual(['ns1.dnsimple.com', 'ns2.dnsimple.com', 'ns3.dnsimple.com', 'ns4.dnsimple.com'],
                             domain_delegation)
    ...
    def test_change_domain_delegation(self):
        ...
        domain_delegation = self.registrar.change_domain_delegation(1010, 'example.com', ['ns1.dnsimple.com',
                                                                                          'ns2.dnsimple.com',
                                                                                          'ns3.dnsimple.com',
                                                                                          'ns4.dnsimple.com']).data
    ...
    def test_change_domain_delegation_to_vanity(self):
        ...
        new_delegation = self.registrar.change_domain_delegation_to_vanity(1010, 'example.com', ['ns1.example.com',
                                                                                                 'ns2.example.com']).data

...
class CertificatesTest(DNSimpleTest):
    ...
    def test_list_certificates_supports_pagination(self):
        responses.add(DNSimpleMockResponse(method=responses.GET,
                                           ...
                                           fixture_name='listCertificates/success'))
        response = self.certificates.list_certificates(1010, 'example.com', page=1, per_page=2)
    ...
    def test_download_certificate(self):
        ...
        certificate_download = self.certificates.download_certificate(1010, 'example.com', 3).data
        ...
        self.assertListEqual(["-----BEGIN CERTIFICATE-----\nMIIEqzCCApOgAwIBAgIRAIvhKg5ZRO08VGQx8JdhT"
                              ...
                              "CERTIFICATE-----"], certificate_download.chain)
    ...
    def test_get_certificate_private_key(self):
        ...
        certificate_bundle = self.certificates.get_certificate_private_key(1010, 'example.com', 5).data
    ...
    def test_issue_letsencrypt_certificate_renewal(self):
        ...
        certificate = self.certificates.issue_letsencrypt_certificate_renewal(1010, 'example.com', 300, 999).data
